"""Regex-based validation for the nuxt-dt-agent-guided fixture.

Guided agent test: model receives full DataTable component API docs inline in the
prompt and writes a single OrdersDataTable.vue using write_file + run_compilation tools.
