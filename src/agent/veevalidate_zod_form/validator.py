"""Regex-based validation for the veevalidate-zod-form agent fixture.

Same logic as src/creation/veevalidate_zod_form/validator.py — duplicated
intentionally since agent and creation fixtures may diverge over time.
