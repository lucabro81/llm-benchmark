"""Regex-based validation for the nuxt-dt-agent-rag fixture.

RAG agent test: model queries RAG for DataTable API docs, then writes
OrdersDataTable.vue + columns.ts using write_file + run_compilation + query_rag tools.
No read_file, no list_files.
