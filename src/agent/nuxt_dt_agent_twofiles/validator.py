"""Regex-based validation for the nuxt-dt-agent-twofiles fixture.

Two-file agent test: model writes OrdersDataTable.vue + columns.ts using
write_file + run_compilation tools. No read_file, no list_files, no query_rag.
