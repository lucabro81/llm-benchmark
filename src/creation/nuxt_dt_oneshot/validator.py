"""Regex-based validation for the nuxt-dt-oneshot fixture.

Single-shot creation test: model receives full DataTable component API docs inline in the
prompt and outputs a single OrdersDataTable.vue (optionally combined with columns.ts).
