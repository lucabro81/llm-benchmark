"""Tests for src/agent/nuxt_dt_agent_rag/validator.py.
...
In the RAG variant, columns live in a separate file — validate_ast_structure
...
from src.agent.nuxt_dt_agent_rag.validator import (
    ASTResult,
    CompilationResult,
    NamingResult,
