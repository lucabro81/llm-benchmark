"""Tests for src/agent/veevalidate_zod_form_nuxt_rag/test_runner.py.
...
from src.agent.veevalidate_zod_form_nuxt_rag.test_runner import AgentBenchmarkResult, AgentTest
...
class TestAgentTestRun:
    ...
    @patch("src.agent.veevalidate_zod_form_nuxt_rag.test_runner.validator")
    @patch("src.agent.veevalidate_zod_form_nuxt_rag.test_runner.run_agent")
